        ...
        <section class="container">
            <section class="content">
                ...
                <p>
                    ...
                    L'ensemble du contenu présent sur le site sae23 incluant, de façon non limitative, les graphismes, images, textes, vidéos, animations, sons, logos, gifs et icônes ainsi que leur mise en forme sont la propriété exclusive de Messieurs ***, ***, *** et *** à l'exception des marques, logos ou contenus appartenant à d'autres sociétés partenaires ou auteurs.<br>

                    <h3>3. Conditions d'utilisation</h3>

                    L'utilisation du site sae23 implique l'acceptation pleine et entière des conditions générales d'utilisation ci-après décrites. Ces conditions d'utilisation sont susceptibles d'être modifiées ou complétées à tout moment, les utilisateurs du site sont donc invités à les consulter de manière régulière.
                    ...
                    Le site sae23 contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de Mr ***. Cependant, sae23 n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait.

                    <h3>6. Droit applicable et attribution de juridiction</h3>

                    Tout litige en relation avec l’utilisation du site sae23 est soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents.
